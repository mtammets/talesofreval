...
export const ArrowRightUp = ({ color = 'currentColor', size = '1.5rem' }) => (
  <svg xmlns='http://www.w3.org/2000/svg' style={{marginBottom: -3}} width={size} height={size} viewBox="0 0 24 24">
    <g fill='none' fillRule='nonzero'>
      ...
      <path fill={color} d='M18 5a1 1 0 0 1 1 1v8a1 1 0 1 1-2 0V8.414l-9.95 9.95a1 1 0 0 1-1.414-1.414L15.586 7H10a1 1 0 1 1 0-2h8Z'/>
    </g>
  </svg>
);
